# Migration `20200721174744-auction-logic-upgrade`

This migration has been generated by rahuldamodar94 at 7/21/2020, 5:47:44 PM.
...
"active" boolean   DEFAULT true,"created" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,"id" SERIAL,"orders_id" integer  NOT NULL ,"price" Decimal(65,30)  NOT NULL ,"signature" text  NOT NULL ,"status" integer   DEFAULT 0,"updated" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,"users_id" integer  NOT NULL ,
    PRIMARY KEY ("id"))
...
"active" boolean   DEFAULT true,"categories_id" integer  NOT NULL ,"chain_id" text  NOT NULL ,"created" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,"erc20tokens_id" integer  NOT NULL ,"expiry_date" timestamp(3)   ,"id" SERIAL,"maker_address" integer   ,"maker_amount" Decimal(65,30)   ,"min_price" Decimal(65,30)  NOT NULL ,"price" Decimal(65,30)  NOT NULL ,"signature" text   ,"status" integer   DEFAULT 0,"taker_address" integer   ,"taker_amount" Decimal(65,30)   ,"tokens_id" text  NOT NULL ,"txhash" text   ,"type" text  NOT NULL ,"updated" timestamp(3)  NOT NULL DEFAULT CURRENT_TIMESTAMP,"views" integer   DEFAULT 0,
    PRIMARY KEY ("id"))
...
migration 20200721173148..20200721174744-auction-logic-upgrade
--- datamodel.dml
+++ datamodel.dml
@@ -3,17 +3,17 @@
 }
